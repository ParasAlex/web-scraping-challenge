...
def init_browser():
    # Setting Up Splinter
    executable_path = {'executable_path': "C:/Users/Alexander Paras/Desktop/Web_Scraping_Challenge/chromedriver.exe"}
...
def scrape_info():
    ...
    # scraping for latest image
    
    #JPL Mars images url
    img_urll = 'https://data-class-jpl-space.s3.amazonaws.com/JPL_Space/image/featured/mars2.jpg'

    #retrieve
    result = requests.get(img_urll)
